...
async function getMembershipsByUser(req: Request, res: Response) {
  try {
...
async function cancelMembership(req: Request, res: Response) {
  try {
...
async function removeSportFromMembership(req: Request, res: Response) {
  try {
