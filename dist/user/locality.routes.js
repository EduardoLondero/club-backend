...
import { findAll, findOne, add, update, remove, findLocalitiesByProvinceId, sanitizeLocalityInput } from './locality.controler.js';
...
localityRouter.get('/findLocationByProvinceId/:id', findLocalitiesByProvinceId);
