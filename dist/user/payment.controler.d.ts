...
declare function sanitizePaymentTypeInput(req: Request, res: Response, next: NextFunction): Promise<Response<any, Record<string, any>> | undefined>;
...
declare function getPaymentsByMembershipID(req: Request, res: Response): Promise<Response<any, Record<string, any>> | undefined>;
